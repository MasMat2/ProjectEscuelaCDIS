...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $.ajax({
                type: "GET",
                url: '<%= ResolveUrl("~/ServicioWCFEscuela.svc/consultaFacultadesJSON") %>',
                success: function (data) {
                    console.log("LLamada de AJAX exitosa");
                    console.log(data);
                    table = `<table class="table table-bordered custom_tables" cellspacing="0" rules="all" border="1" id="tableFromAjax"
                   ...
                   for (facultad of facultades) {
                       table += `<tr>
                            ...
                            <td>${facultad.nombreUniversidad}</td>
